...
print("Accuracy of the 2nd approche: ", metrics_lda.accuracy(y_test, y_pred2))
print("Precision of the 2nd approche: ", metrics_lda.precision(y_test, y_pred2))
print("Recall of the 2nd approche: ", metrics_lda.recall(y_test, y_pred2))
print("F1 of the 2nd approche: ", metrics_lda.f1_score(y_test, y_pred2))
metrics_lda.learning_curve_lda(X_train, y_train, X_test, y_test)
"""
